...
export const StatAllocation: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.instruction}>Tap a stat to allocate 1 point</Text>

      <View style={styles.statsGrid}>
        {(Object.keys(character.stats) as (keyof CharacterStats)[]).map(
          (statKey) => {
            ...
            return (
              ...
              >
                ...
                <View style={styles.statValueContainer}>
                  <Text style={[styles.statValue, { color }]}>{statValue}</Text>
                  <View
                    style={[
                      styles.addButton,
                      {
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>• AGI: Consistency and streaks</Text>
        <Text style={styles.infoText}>• INT: Learning and mental habits</Text>
        <Text style={styles.infoText}>• VIT: Health and wellness habits</Text>
        <Text style={styles.infoText}>
